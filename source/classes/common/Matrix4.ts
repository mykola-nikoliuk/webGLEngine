	...
	export class Matrix4 {
		...
		public multiply(matrix : Matrix4) : Matrix4 {
			var a = this.matrixArray,
				...
				m00 = a[0], m01 = a[1], m02 = a[2], m03 = a[3], m10 = a[4], m11 = a[5], m12 = a[6], m13 = a[7], m20 = a[8], m21 = a[9], m22 = a[10], m23 = a[11], m30 = a[12], m31 = a[13], m32 = a[14], m33 = a[15],
				n00 = b[0], n01 = b[1], n02 = b[2], n03 = b[3], n10 = b[4], n11 = b[5], n12 = b[6], n13 = b[7], n20 = b[8], n21 = b[9], n22 = b[10], n23 = b[11], n30 = b[12], n31 = b[13], n32 = b[14], n33 = b[15];
		...
		public inverse() : Matrix4 {
			...
			var a = this.matrixArray,
				b = a,
				c = a[0], d = a[1], e = a[2], g = a[3], f = a[4], h = a[5], i = a[6], j = a[7], k = a[8], l = a[9], o = a[10], m = a[11], n = a[12], p = a[13], r = a[14], s = a[15], A = c * h - d * f, B = c * i - e * f, t = c * j - g * f, u = d * i - e * h, v = d * j - g * h, w = e * j - g * i, x = k * p - l * n, y = k * r - o * n, z = k * s - m * n, C = l * r - o * p, D = l * s - m * p, E = o * s - m * r, q = 1 / (A * E - B * D + t * C + u * z - v * y + w * x);
